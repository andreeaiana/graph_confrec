...
#        preprocessor = Processor(self.embedding_type, graph_type, gpu)
...
#
#        # Infer embeddings
#        pool = mp.pool.Pool(processes=1)
#        citations_args = (query_test, None, "citations",
#                          graphsage_model_citations,
#                          args.model_checkpoint_citations)
#        authors_args = (query_test, query_test_authors, "authors",
#                        graphsage_model_authors,
#                        args.model_checkpoint_authors)
#        job = pool.starmap_async(evaluation_model.infer_embeddings,
#                                 [citations_args, authors_args])
#        pool.close()
#        pool.join()
#        if job.ready():
#            print("Job is ready, getting results.")
#            results = job.get()
#        pool.terminate()
#
#        # Concatenate embeddings

...
class SupervisedGraphsage(models.SampleAndAggregate):
    ...
    def __init__(self, num_classes, placeholders, features, adj, degrees,
                 layer_infos, weight_decay, learning_rate, concat=True,
                 aggregator_type="mean", model_size="small",
    ...
    def build(self):
        ...
        num_samples = [layer_info.num_samples for
                       layer_info in self.layer_infos]
